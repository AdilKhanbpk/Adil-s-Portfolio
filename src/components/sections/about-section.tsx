...
const SkillBar = ({ skill, index }: { skill: Skill; index: number }) => {
  return (
    <ScrollAnimationItem className="mb-3" direction="left" distance={50}>
              ...
              <ScrollAnimation direction="up" delay={0.5} className="mt-8">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  ...
                  <div className="flex flex-col gap-1 w-full">
                    ...
                    <span
                      className="text-muted-foreground text-[10px] sm:text-sm w-full email-text"
                      title="adilkhanbpk@gmail.com"
                    >
        ...
        <ScrollAnimationItem direction="scale">
          <Card className="glass-card p-6 py-8 h-full">
            <div className="flex flex-col items-center justify-between text-center h-full">
              ...
              <p className="text-sm text-muted-foreground">
                I create visually appealing designs that enhance user
                experience.
              </p>
            </div>
          </Card>
